...
class CreateWorkflowResponse:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.blog_id is not None:
            result["blog_id"] = self.blog_id
...
class BatchCreateItemResult:
    ...
    """Workflow record_id (present when success)."""
    instance_id: Optional[str] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.status_url is not None:
            out["status_url"] = self.status_url
        if self.error is not None:
            out["error"] = self.error
        return out
...
class BatchWebsiteStatusItem:
    ...
    def to_dict(self) -> Dict[str, Any]:
        out: Dict[str, Any] = {"success": self.success, "record_id": self.record_id}
...
class WorkspaceCredits:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.reset_date is not None:
            result["reset_date"] = self.reset_date
        return result

    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "WorkspaceCredits":
        """Create an instance from a dictionary."""
        return cls(
